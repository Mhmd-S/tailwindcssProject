...
const Header = () => {
  return (
    <header className='w-4/5 grid grid-cols-[80%_10%_10%] border-b-4 mx-auto py-8 border-white '>
        ...
        <button className='justify-self-end text-white font-bold tracking-wider border-b-4 border-transparent hover:border-b-4 hover:border-orange-500 ease-in duration-300'>Posts</button>
