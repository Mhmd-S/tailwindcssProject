...
const Header = ({  darkMode , setDarkMode }) => {
  return (
    <header className='w-4/5 grid grid-cols-[80%_10%_10%] border-b-4 mx-auto py-8 border-[#141414] dark:border-white'>
        <Link to='/' className='w-fit'><AiOutlineBug size={50} color={darkMode ? "white" : "black"} /></Link>
        
        <Link to='/posts' className='relative justify-self-end self-center text-[#121212] font-bold tracking-wider mr-4 before:block before:absolute before:w-full  before:top-10 before:scale-x-0 before:origin-bottom-right before:h-[0.25rem] before:bg-[#3513dc] before:hover:scale-x-100 before:hover:origin-top-left before:transition-transform dark:text-white dark:before:bg-orange-500'>Posts</Link>
